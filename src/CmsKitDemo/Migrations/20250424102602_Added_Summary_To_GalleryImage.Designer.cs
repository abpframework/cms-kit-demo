...
{
    [DbContext(typeof(CmsKitDemoDbContext))]
    [Migration("20250424102602_Added_Summary_To_GalleryImage")]
    partial class Added_Summary_To_GalleryImage
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CmsKitDemo.Entities.GalleryImage", b =>
                {
                    ...
                    b.Property<string>("CommentsSummary")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("CmsDemoImages", (string)null);
                });
