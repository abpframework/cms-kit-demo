...
public class CmsKitDemoDbMigrationService : ITransientDependency
{
    public ILogger<CmsKitDemoDbMigrationService> Logger { get; set; }
    ...
    private string GetEntityFrameworkCoreProjectFolderPath()
    {
        ...
        return Path.Combine(slnDirectoryPath, "CmsKitDemo");
    }
